...
`dibs` works in its two main modes of operation: _development_ and _alien_.

=== Development Mode

As the name implies, _development mode_ is best used when developing the
software and generating the container image during development itself (e.g. as
a developer).
